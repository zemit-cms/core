    ...
    public function morph(): void
    {
        $this->morphTable('menu', [
            ...
            'indexes' => [
                ...
                new Index('idx_parent_id', ['parent_id'], ''),
                new Index('fk_menu_created_by', ['created_by'], ''),
                new Index('fk_menu_updated_by', ['updated_by'], ''),
                new Index('fk_menu_deleted_by', ['deleted_by'], ''),
            ],
            'references' => [
                new Reference(
                    'fk_menu_created_by',
