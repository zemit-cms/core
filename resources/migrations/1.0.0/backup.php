    ...
    public function morph(): void
    {
        ...
        $this->morphTable('backup', [
            ...
            'indexes' => [
                ...
                new Index('fk_backup_created_by', ['created_by'], ''),
                new Index('fk_backup_updated_by', ['updated_by'], ''),
                new Index('fk_backup_deleted_by', ['deleted_by'], ''),
            ],
            'references' => [
                new Reference(
                    'fk_backup_created_by',
                    [
