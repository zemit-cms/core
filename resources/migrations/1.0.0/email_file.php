    ...
    public function morph(): void
    {
        $this->morphTable('email_file', [
            ...
            'indexes' => [
                ...
                new Index('uq_email_file', ['email_id', 'file_id'], 'UNIQUE'),
                new Index('idx_file_id', ['file_id'], ''),
                new Index('fk_email_file_created_by', ['created_by'], ''),
            ],
            'references' => [
                new Reference(
                    'fk_email_file_created_by',
                    [
