    ...
    public function morph(): void
    {
        ...
        $this->morphTable('user_role', [
            ...
            'indexes' => [
                ...
                new Index('uq_user_role', ['user_id', 'role_id'], 'UNIQUE'),
                new Index('idx_role_id', ['role_id'], ''),
                new Index('fk_user_role_created_by', ['created_by'], ''),
                new Index('fk_user_role_updated_by', ['updated_by'], ''),
                new Index('fk_user_role_deleted_by', ['deleted_by'], ''),
            ],
            'references' => [
                new Reference(
                    'fk_user_role_created_by',
                    [
