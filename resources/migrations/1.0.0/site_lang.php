    ...
    public function morph(): void
    {
        $this->morphTable('site_lang', [
            ...
            'indexes' => [
                ...
                new Index('uq_site_lang', ['site_id', 'lang_id'], 'UNIQUE'),
                new Index('idx_lang_id', ['lang_id'], ''),
                new Index('fk_site_lang_created_by', ['created_by'], ''),
            ],
            'references' => [
                new Reference(
                    'fk_site_lang_created_by',
                    [
