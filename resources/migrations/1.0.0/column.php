    ...
    public function morph(): void
    {
        ...
        $this->morphTable('column', [
            'columns' => [
                ...
                new Column(
                    ...
                    [
                        ...
                        'notNull' => false,
                        'comment' => "Stores options for select, formula, lookups etc.",
                        'after' => 'description'
                    ]
                ),
                new Column(
            ...
            'indexes' => [
                ...
                new Index('idx_table_id', ['table_id'], ''),
                new Index('fk_column_created_by', ['created_by'], ''),
                new Index('fk_column_updated_by', ['updated_by'], ''),
                new Index('fk_column_deleted_by', ['deleted_by'], ''),
            ],
            'references' => [
                new Reference(
                    'fk_column_created_by',
                    [
