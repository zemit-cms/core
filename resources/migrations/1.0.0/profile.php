    ...
    public function morph(): void
    {
        $this->morphTable('profile', [
            ...
            'indexes' => [
                ...
                new Index('user_id_UNIQUE', ['user_id'], 'UNIQUE'),
                new Index('fk_profile_created_by', ['created_by'], ''),
                new Index('fk_profile_updated_by', ['updated_by'], ''),
                new Index('fk_profile_deleted_by', ['deleted_by'], ''),
            ],
            'references' => [
                new Reference(
