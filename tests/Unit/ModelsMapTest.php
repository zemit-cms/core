...
class ModelsMapTest extends AbstractUnit
{
    ...
    public function testModelsMap(): void
    {
        $classesMap = [
            ...
            \Zemit\Models\Site::class => \Zemit\Models\Site::class,
            \Zemit\Models\SiteLang::class => \Zemit\Models\SiteLang::class,
        ...
        $classes = [
            ...
            \Zemit\Models\Site::class => $this->getSiteClass(),
            \Zemit\Models\SiteLang::class => $this->getSiteLangClass(),
            ...
            \Zemit\Models\Channel::class => $this->getChannelClass(),
