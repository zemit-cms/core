...
class ModelsMapTest extends AbstractUnit
{
    ...
    public function testModelsMap(): void
    {
        ...
        $classes = [
            ...
            \Zemit\Models\Workspace::class => $this->getWorkspaceClass(),
            \Zemit\Models\WorkspaceLang::class => $this->getWorkspaceLangClass(),
            ...
            \Zemit\Models\Table::class => $this->getTableClass(),
