...
class ModelsTest extends AbstractUnit
{
    ...
    public function testModelsMap(): void
    {
        $instances = [
            ...
            \Zemit\Models\TranslateField::class => $this->models->getTranslateField(),
            \Zemit\Models\TranslateTable::class => $this->models->getTranslateTable(),
            ...
            \Zemit\Models\Field::class => $this->models->getField(),
