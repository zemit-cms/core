...
abstract class TranslateTableAbstract extends AbstractModel implements TranslateTableAbstractInterface
{
     ...
     * @var RawValue|int|null
     */
    public RawValue|int|null $leftId = null;
    
    /**
     * Column: right_id
     * @var RawValue|int|null
     */
    public RawValue|int|null $rightId = null;
     ...
     * @return RawValue|int|null
     */
    public function getLeftId(): RawValue|int|null
    {
        return $this->leftId;
    }
     ...
     * Column: left_id 
     * @param RawValue|int|null $leftId
     * @return void
     */
    public function setLeftId(RawValue|int|null $leftId): void
    {
        $this->leftId = $leftId;
    }
     ...
     * @return RawValue|int|null
     */
    public function getRightId(): RawValue|int|null
    {
        return $this->rightId;
    }
     ...
     * Column: right_id 
     * @param RawValue|int|null $rightId
     * @return void
     */
    public function setRightId(RawValue|int|null $rightId): void
    {
